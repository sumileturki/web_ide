  ...
  return (
    <>
      <div className="sticky top-0 left-0 right-0 z-50">
        <div className="bg-[#f6eff2] dark:bg-black/5 w-full">
          {/* Rest of the header content */}
          <div className="flex items-center justify-center w-full flex-col">
            <div
              className={`
                            flex items-center justify-between
                            bg-linear-to-b from-[#f6e6ee]/90 via-[#f6e6ee]/90 to-[#f6e6ee]/90

                            dark:from-[#12242e]/90 dark:via-[#12242e]/90 dark:to-[#12242e]/90
